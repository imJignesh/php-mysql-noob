    ...
    <div class="col-md-4">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input autocomplete="off" class="form-control" type="text" name="keyword" placeholder="Search Keyword" />
            </div>
            <div class="form-group">
...
while( $students  = $query->fetch_row() ){
    ?>
            <tr>
                <td><?php echo $students[4]?"<img class='rounded-circle' width='50' height='50' src='$students[4]' />":"<img class='rounded-circle' width='50' height='50' src='https://www.gravatar.com/avatar/EMAIL_MD5?d=https%3A%2F%2Fui-avatars.com%2Fapi%2F/".$students[1]."/50/random' />"; ?></td>
